...
public class ServizioFile implements Serializable 
{
	...
	public static void salvaSingoloOggetto (File f, Object daSalvare)
	 {
		 ...
		 if(f == null)
			 JOptionPane.showMessageDialog(null, "Qualcosa è andato storto... prova a chiudere la partita\n");
		 else{
			 try
				{
